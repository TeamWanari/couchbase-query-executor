...
public class Parameter<T> {
    ...
    public Parameter(String key, String value, Function<String, Boolean> condition, BiFunction<String, String, Expression> expressionMethod, Function<String, T> parser, ParameterType type) {
        this.key = key;
        this.value = value;
    ...
    public Parameter(String key, String value, Function<String, Boolean> condition, BiFunction<String, String, Expression> expressionMethod, ParameterType type) {
        this.key = key;
        this.value = value;
        this.condition = condition;
        this.expressionMethod = expressionMethod;
